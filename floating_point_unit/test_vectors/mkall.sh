...
#rem -------------------- f#rem round to nearest even

./pg -q -r 0 -m 64 -p 0          -o rtne/f#rem_pat0.hex

./pg -q -r 0 -m 64 -p 1          -o rtne/f#rem_pat1.hex

./pg -q -r 0 -m 64 -p 2          -o rtne/f#rem_pat2.hex

./pg -q -r 0 -m 64 -n 199990 -ll -o rtne/f#rem_lg.hex

./pg -q -r 0 -m 64 -n 199990     -o rtne/f#rem_sm.hex


#rem -------------------- f#rem round to zero

./pg -q -r 3 -m 64 -p 0          -o rtzero/f#rem_pat0.hex

./pg -q -r 3 -m 64 -p 1          -o rtzero/f#rem_pat1.hex

./pg -q -r 3 -m 64 -p 2          -o rtzero/f#rem_pat2.hex

./pg -q -r 3 -m 64 -n 199990 -ll -o rtzero/f#rem_lg.hex

./pg -q -r 3 -m 64 -n 199990     -o rtzero/f#rem_sm.hex



#rem -------------------- f#rem round to inf + (up)

./pg -q -r 2 -m 64 -p 0          -o rup/f#rem_pat0.hex

./pg -q -r 2 -m 64 -p 1          -o rup/f#rem_pat1.hex

./pg -q -r 2 -m 64 -p 2          -o rup/f#rem_pat2.hex

./pg -q -r 2 -m 64 -n 199990 -ll -o rup/f#rem_lg.hex

./pg -q -r 2 -m 64 -n 199990     -o rup/f#rem_sm.hex



#rem -------------------- f#rem round to inf - (down)

./pg -q -r 1 -m 64 -p 0          -o rdown/f#rem_pat0.hex

./pg -q -r 1 -m 64 -p 1          -o rdown/f#rem_pat1.hex

./pg -q -r 1 -m 64 -p 2          -o rdown/f#rem_pat2.hex

./pg -q -r 1 -m 64 -n 199990 -ll -o rdown/f#rem_lg.hex

./pg -q -r 1 -m 64 -n 199990     -o rdown/f#rem_sm.hex
